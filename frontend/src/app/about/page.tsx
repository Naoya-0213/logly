...
const versionHistory = [
  {
    ...
    changes: [
      "ダッシュボードに連続記録日数（🔥）を追加",
      "ダッシュボードのグラフに週別・月別タブを追加",
      "月別グラフを追加（年単位ナビ・クリックで円グラフ連動）",
      "カレンダー機能を追加（BottomTabの履歴をカレンダーに変更）",
      "カレンダー画面にリスト表示タブを追加",
      "タイムゾーンをJST対応に修正",
    ],
  },
  {
    ...
    date: "2026年6月",
    changes: [
      "記録追加画面の勉強時間入力を改善（直接入力・1分刻み・合計表示）",
      "記録追加画面に最近の記録サジェスト機能を追加",
      "履歴一覧に曜日表示・日別合計時間を追加",
      "PWA対応（ホーム画面からアプリのように起動可能）",
      "モバイルのスクロール挙動を修正",
      "カテゴリーの色を13色に拡充",
    ],
  },
